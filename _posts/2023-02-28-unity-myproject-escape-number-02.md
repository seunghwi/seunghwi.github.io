...
# 첫번째 기획 방법 
목표와 스토리를 정하고 게임 내에서 사용 할 수 있는 요소를 나열하고, 기본적인 UI 프로토타입을 정하겠습니다. 이번에 모든것을 구체화 하지 않고 추가 기획이 다음 포스팅에서 계속 이어질 예정입니다. 미션 상세 기획을 제외한 나머지 기획은 약 5~7개 정도의 포스팅이 필요하지 않을까 예상해봅니다.
